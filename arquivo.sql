...
INSERT INTO `categoria` VALUES (1,'Escritório'),(2,'Informática'),(3,'Cama mesa e banho'),(4,'Eletônicos'),(5,'Jardinagem'),(6,'Decoração'),(7,'Perfumaria');
...
INSERT INTO `cidade` VALUES (1,'Uberlãndia',1),(2,'São Paulo',2),(3,'Campinas',2);
...
INSERT INTO `cliente` VALUES (1,'90652158968','maria@hotmail.com','Maria silva',1);
...
INSERT INTO `endereco` VALUES (1,'Jardim','3895546','Apto 303','Rua flores',300,1,1),(2,'Centro','389232','sala 800','Avenida Matos',105,2,1);
...
INSERT INTO `item_pedido` VALUES (0.00,1,2000.00,1,1),(0.00,2,80.00,1,3),(100.00,1,800.00,2,2);
...
INSERT INTO `pagamento_com_boleto` VALUES (NULL,'2019-01-01',2);
...
INSERT INTO `pedido` VALUES (1,'2018-08-01 04:24:00',1,1),(2,'2018-10-10 04:24:00',1,2);
...
INSERT INTO `produto` VALUES (1,'Computador',2000.00),(2,'Impressora',800.00),(3,'Mouse',80.00),(4,'Mesa de escritório',300.00),(5,'Toalha',50.00),(6,'Colcha',200.00),(7,'TV true color',1200.00),(8,'Roçadeira',800.00),(9,'Abajour',100.00),(10,'Pendente',180.00),(11,'Shampoo',90.00);
...
INSERT INTO `produto_categoria` VALUES (1,2),(1,4),(2,1),(2,2),(2,4),(3,2),(3,4),(4,1),(5,3),(6,3),(7,4),(8,5),(9,6),(10,6),(11,7);
...
INSERT INTO `telefone` VALUES (1,'34675873'),(1,'985620178');
...
-- Dump completed on 2018-08-20 23:22:06
